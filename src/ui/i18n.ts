...
const fr = {
  ...
  'rules.9.body':
    "Si la table les a activées : huit cases marquées, deux par camp, aux mêmes distances de chaque départ. S'arrêter dessus fait piocher un bonus ou un malus dans un paquet commun.",
  ...
  'power.des': 'Dé pipé',
  'power.des.desc': 'Un bonus de dé de plus dans le budget commun de la table.',
...
const en: Partial<Record<Key, string>> = {
  ...
  'rules.9.body':
    'If the table turned them on: eight marked squares, two per colour, at the same distances from every start. Landing on one draws a bonus or a penalty from a shared deck.',
  ...
  'power.des.desc': 'One more die bonus in the table’s shared budget.',
