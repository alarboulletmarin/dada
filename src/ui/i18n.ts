...
const fr = {
  ...
  'home.create.hint': 'Vous hébergez, vos amis vous rejoignent avec un code ou un QR',
  ...
  'lobby.qr': 'Montrer le QR code',
  'lobby.qr.title': 'Scannez pour rejoindre',
  'lobby.qr.hint':
    "Visez le carré avec l'appareil photo. Trop loin pour scanner ? Le code se tape aussi.",
  'lobby.qr.aria': 'QR code de la partie {code}',
  ...
  'lobby.bot.hint': 'Touchez les points d’un bot pour régler son niveau.',
  'lobby.bot.level': 'Niveau de {name} : {level}. Toucher pour changer.',
  'lobby.bot.level.read': 'Niveau de {name} : {level}.',
  'level.tranquille': 'Tranquille',
  'level.normal': 'Normal',
  'level.redoutable': 'Redoutable',
  'level.tranquille.desc':
    'Il avance sans regarder derrière lui, oublie parfois qu’il peut vous manger, et laisse dormir ses cartes.',
  'level.normal.desc':
    'Il mange dès qu’il peut, évite de se garer devant vous, et garde ses cartes pour un coup sûr.',
  'level.redoutable.desc':
    'Il compte ce qu’une capture rapporte vraiment, se réfugie sur les cases abritées, fuit au galop et dépense ses bonus de dé.',
  'lobby.addBot': '+ Bot',
  'lobby.host': 'hôte',
  'lobby.bot': 'bot',
  ...
  'lobby.reface': 'Relancer le portrait de {name}',
  'lobby.reface.short': 'Relancer le portrait',
  'lobby.swap': 'Changer {name} de place',
  'lobby.swap.short': 'Changer de place',
  'lobby.swap.cancel': 'Laisser {name} à sa place',
  'lobby.swap.hint': 'Touchez un autre joueur : vous échangez vos places.',
  'lobby.rules': 'Règles maison',
  'lobby.change': 'Changer de jeu',
  'lobby.start': 'Lancer la partie',
  'lobby.needTwo': 'Il faut au moins 2 joueurs',
  'lobby.needFour': 'Il faut exactement 4 joueurs',
  'lobby.team': 'Équipe {team}',
  'lobby.teams.hint': 'Les sièges face à face jouent ensemble.',
  ...
  'react.open': 'Réagir',
  'react.close': 'Fermer les réactions',
  'react.do': 'Réagir : {what}',
  'react.laugh': 'rire',
  'react.scream': 'cri',
  'react.anger': 'colère',
  'react.horse': 'cheval',
  ...
  'play.playFor': '{name} joue pour {partner}',
  'play.playFor.you': 'À vous — vous jouez pour {partner}',
  'play.relay.title': 'Quatre chevaux rentrés',
  'play.relay': '{name} a fini — il joue maintenant pour {partner}',
  'play.rolled': '{name} a fait {dice}',
  'play.youRolled': 'Vous avez fait {dice}',
  'play.pickOne': 'un seul coup : il se joue',
  'play.pickOne.card': 'un seul coup — une carte d’abord ?',
  'play.pickOne.tap': 'touchez le cheval cerclé',
  'play.pickMany': 'choisissez un cheval cerclé',
  'play.nothing': 'Rien à jouer',
  'play.nothing.hint': 'on passe la main',
  'play.nothing.card': 'une carte d’abord ? sinon on passe',
  ...
  'play.zoom.in': 'Agrandir le plateau',
  'play.zoom.out': 'Revoir tout le plateau',
  'play.seconds': '{n} s',
  ...
  'toast.eaten.title': 'Cheval mangé',
  'toast.eaten': 'le cheval {pawn} de {victim} retourne à l’écurie',
  'toast.skipped': '{name} saute son tour.',
  'hand.title': 'Vos cartes',
  'hand.open': 'Vos cartes — {n} sur {max}',
  'hand.open.armed': 'Vos cartes — « {power} » est prête',
  'hand.playable': 'jouable maintenant',
  'hand.later': 'pas maintenant',
  'hand.count': '{n}/{max} carte(s) en main',
  'hand.aim': 'choisissez un cheval',
  'hand.aim.needed': 'Choisissez d’abord un cheval sur le plateau.',
  'hand.boost.needed': 'Demandez votre petit ou votre grand nombre.',
  'hand.roll': 'lancez le dé pour jouer la carte',
  'hand.roll.boost': 'petit ou grand nombre ? les deux lancent',
...
const en: Partial<Record<Key, string>> = {
  ...
  'home.create.hint': 'You host; your friends join with a code or a QR',
  ...
  'lobby.qr': 'Show the QR code',
  'lobby.qr.title': 'Scan to join',
  'lobby.qr.hint': 'Point a camera at the square. Too far to scan? The code can be typed.',
  'lobby.qr.aria': 'QR code for game {code}',
  'lobby.invite': 'Join my game of little horses — code {code}',
  'lobby.players': 'Players · {n}/4',
  'lobby.free': 'free seat',
  'lobby.addPlayer': '+ Player',
  'lobby.bot.hint': 'Tap a bot’s dots to set how tough it plays.',
  'lobby.bot.level': '{name}’s level: {level}. Tap to change.',
  'lobby.bot.level.read': '{name}’s level: {level}.',
  'level.tranquille': 'Easy-going',
  'level.normal': 'Steady',
  'level.redoutable': 'Fierce',
  'level.tranquille.desc':
    'It moves along without looking behind, sometimes misses a capture, and lets its cards sit.',
  'level.normal.desc':
    'It captures whenever it can, avoids parking in front of you, and saves its cards for a sure thing.',
  'level.redoutable.desc':
    'It weighs what a capture is really worth, hides on safe squares, gallops out of danger and spends its die boosts.',
  'lobby.addBot': '+ Bot',
  'lobby.host': 'host',
  'lobby.bot': 'bot',
  ...
  'lobby.reface': "Reroll {name}'s portrait",
  'lobby.reface.short': 'Reroll portrait',
  'lobby.swap': 'Move {name} to another seat',
  'lobby.swap.short': 'Change seats',
  'lobby.swap.cancel': 'Leave {name} where they are',
  'lobby.swap.hint': 'Tap another player: the two of you swap seats.',
  'lobby.rules': 'House rules',
  'lobby.change': 'Change game',
  'lobby.start': 'Start the game',
  'lobby.needTwo': 'At least 2 players needed',
  'lobby.needFour': 'Exactly 4 players needed',
  'lobby.team': 'Team {team}',
  'lobby.teams.hint': 'Seats facing each other play together.',
  ...
  'play.playFor': '{name} is playing for {partner}',
  'play.playFor.you': 'Your turn — you are playing for {partner}',
  'play.relay.title': 'All four horses home',
  'play.relay': '{name} is done — now playing for {partner}',
  'play.rolled': '{name} rolled {dice}',
  'play.youRolled': 'You rolled {dice}',
  'play.pickOne': 'only one move: playing it',
  'play.pickOne.card': 'only one move — a card first?',
  'play.pickOne.tap': 'tap the circled horse',
  'play.pickMany': 'pick a circled horse',
  'play.nothing': 'Nothing to play',
  'play.nothing.hint': 'passing the turn',
  'play.nothing.card': 'a card first? otherwise we pass',
  ...
  'play.zoom.in': 'Zoom in on the board',
  'play.zoom.out': 'Show the whole board',
  'play.seconds': '{n}s',
  ...
  'toast.eaten.title': 'Horse eaten',
  'toast.eaten': '{victim}’s horse {pawn} goes back to the stable',
  'toast.skipped': '{name} skips a turn.',
  'hand.title': 'Your cards',
  'hand.open': 'Your cards — {n} of {max}',
  'hand.open.armed': 'Your cards — “{power}” is ready',
  'hand.playable': 'playable now',
  'hand.later': 'not right now',
  'hand.count': '{n}/{max} card(s) in hand',
  'hand.aim': 'pick a horse',
  'hand.aim.needed': 'Pick a horse on the board first.',
  'hand.boost.needed': 'Ask for your low or your high number.',
  'hand.roll': 'roll the die to play the card',
  'hand.roll.boost': 'low or high? both roll the die',
