...
const fr = {
  ...
  'rules.3.body': 'Tomber pile sur un cheval adverse le renvoie chez lui. Les cases ✦ protègent.',
...
const en: Partial<Record<Key, string>> = {
  ...
  'rules.3.body': 'Landing exactly on a rival horse sends it home. ✦ squares protect.',
